...
app.post('/api/staff/plantel', auth_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        for (const p of plantel) {
            const existing = yield prisma.personal.findMany({
                where: {
                    DNI: p.DNI,
                    Activo: true,
        ...
        const inserted = yield prisma.$transaction(plantel.map(p => prisma.personal.upsert({
            where: { DNI: p.DNI },
            update: {
...
app.get('/api/staff/active', auth_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const servicioId = ((_a = req.user) === null || _a === void 0 ? void 0 : _a.servicioId) || Number(req.query.servicioId); // Usar token si está
    if (!servicioId) {
    ...
    try {
        ...
        const activePadron = yield prisma.padronHabilitados.findMany({
            where: { Activo: true }
        });
        ...
        const verifiedStaff = staff
            ...
            return Object.assign(Object.assign({}, s), { bajaProvisoriaHoy: isBajaHoy, bajaDefinitivaHoy: !s.Activo, bajaMotivo: s.BajaMotivo });
        });
...
app.post('/api/emergencies', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield prisma.pedidosComida.createMany({ data: newOrders });
        yield (0, audit_1.logAudit)(req, 'ALTA_EMERGENCIA', `Solicitud de emergencia creada para DNI ${dni} del ${start.toISOString().split('T')[0]} al ${end.toISOString().split('T')[0]}`);
...
app.get('/api/emergencies/pending', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
app.post('/api/emergencies/:id/resolve', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
...
app.post('/api/personal/bulk', auth_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        for (const row of data) {
            if (!row.documento || !row.agente)
                continue;
            let hospital = yield prisma.hospitales.findFirst({ where: { Nombre: String(row.efector).trim() } });
            if (!hospital) {
            ...
            let servicio = yield prisma.servicios.findFirst({ where: { Nombre: String(row.servicio).trim(), HospitalId: hospital.Id } });
            if (!servicio) {
